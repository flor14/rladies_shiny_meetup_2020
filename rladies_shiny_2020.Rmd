...
knitr::include_graphics("mamu_8_sd.png")
```
...
```{r echo=TRUE, tidy=FALSE, fig.align="center", out.width='90%'}
library(ggplot2)
...
ui<- fluidPage(
          sidebarLayout(
                sidebarPanel(radioButtons("Vx",
                                          "Eje X",
                                          selected = "displ",
                                          choices= c("Millas de autopista por galon"="hwy", "Millas de ciudad por galon"="cty", "Cilindrada del motor (L)"="displ"))),
                mainPanel()))
...
ui<- fluidPage(theme = shinytheme("lumen"), #<<
               h1(strong("Rladies Buenos Aires")), #<<
...
```{r hopña, echo=FALSE, fig.align="center", out.width='90%'}
